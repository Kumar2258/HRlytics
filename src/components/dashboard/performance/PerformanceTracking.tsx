...
import { TrendingUp, Target, Award, BarChart2, Calendar } from 'lucide-react';
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
              {[
                ...
                <tr key={index} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-900 dark:text-white">{item.target}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-900 dark:text-white">{item.achieved}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
